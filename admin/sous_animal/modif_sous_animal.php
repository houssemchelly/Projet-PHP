...
<body>
    <div class="form-container">
        ...
        <form action="enregistres.php" method="POST">
            ...
            name: <input type="text" name="name" value="<?php echo htmlspecialchars($animal['name']); ?>" required><br>
            image: <input type="url" name="image" value="<?php echo htmlspecialchars($animal['image']); ?>" required><br>
            prix: <input type="number" name="prix" value="<?php echo htmlspecialchars($animal['prix']); ?>" required><br>
            categorie: 
            <?php
